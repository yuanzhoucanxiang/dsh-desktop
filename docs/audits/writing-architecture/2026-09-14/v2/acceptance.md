...
> 2026-09-20 阅读体验与窄栏补测见 [最新报告](../../2026-09-20/review.md)。改动仍未发布；本文历史矩阵不替代最新验收范围。

> 2026-09-19 后续验收：真实模型三场景、同一真实 host 下两个 Electron 窗口已实际验证；另修复助手候选来源丢失与 Windows 换行门禁。
> **这些新修复尚未发布**。本文件保留当时的 30 项矩阵与证据，最新结论、作用范围及剩余项见 [独立复核报告](../../2026-09-19/review.md)，不能把下文旧的 NOT_RUN 或 PASS 当成本轮结论。
