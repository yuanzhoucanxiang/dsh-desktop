...
fixture=fixture.slice(0,cut)+String.raw`
  ...
  fs.writeFileSync(path.join(repo,'docs/audits/writing-architecture/2026-09-14/v2-review2/ui-results.json'),JSON.stringify({commit:'dcc2c88075fabe5bdf9a0f46d5863112ad2a0c36',temp,results,rendererErrors:errors},null,2)+'\n')
