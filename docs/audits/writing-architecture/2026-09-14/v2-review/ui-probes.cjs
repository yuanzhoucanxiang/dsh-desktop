...
fixture=fixture.slice(0,cut)+String.raw`
  ...
  fs.writeFileSync(path.join(repo,'docs/audits/writing-architecture/2026-09-14/v2-review/ui-results.json'),JSON.stringify({commit:'95b138d427f445e933e69811f8a775ce968ffe28',temp,results,rendererErrors:errors},null,2)+'\n')
