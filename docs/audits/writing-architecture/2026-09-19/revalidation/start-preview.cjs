...
const base=fs.mkdtempSync(path.join(os.tmpdir(),'dsh-preview','writing-acceptance-20260919-'))
...
const exe=path.join(os.tmpdir(),'wm-acceptance-2026-09-19/win-unpacked/DeepSeek Harness Desktop.exe')
