@echo off
rem Upgrade to 0.1.5 (hoisted runtime, short paths): kill app, DELETE old dir, fresh install, verify, relaunch.
...
set "SETUP=E:\Deepseek harness\dsh-desktop\dist\dsh-desktop-0.1.5-setup.exe"
...
echo [3/5] Installing 0.1.5 (silent)...
if not exist "%SETUP%" (
